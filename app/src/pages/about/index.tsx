    ...
    <div className='mu-flex mu-flex__horizon'>
      ...
      <div className='mu-profile'>
        ...
        <p className='mu-profile__text'>
          ITエンジニアとして主に社内のWebアプリケーション開発・運用・保守に従事.
          <br />
          安全という言葉が好き.
          <br />
        ...
        <div className='mu-flex mu-flex__horizon'>
          <a
            href='https://github.com/muratomo'
            target='_blank'
          ...
          <a
            href='https://twitter.com/muratomo_4_4'
            target='_blank'
            rel='noopener noreferrer'
          >
          ...
          <a
            href='https://www.pixiv.net/users/1862637'
            target='_blank'
            rel='noopener noreferrer'
          >
  ...
  render(): JSX.Element {
    return (
      <div className='mu-page mu-flex mu-flex__vertical'>
        <Header />
        <section className='mu-flex__main'>{profile}</section>
        <Footer />
      </div>
    )
  }
